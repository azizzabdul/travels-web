                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form action="{{ route('checkout-create', $item->id) }}" class="form-inline" method="POST">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" name="username" id="username" placeholder="Username" required>
                                
                                <label for="nationality" class="sr-only">Nationality</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" name="nationality" id="nationality" placeholder="Nationality" style="width: 50px" required>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <p class="payment-instructions">
                            Please complete payment before to countinue the wonderful trip.<br>
                            You will redirected to another page to pay using GO-PAY
                        </p>
                        {{-- <div class="bank">
